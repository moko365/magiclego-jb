...
define maker_libs
	...
	make INV_CACHE_DMP=1 MLSDK_ROOT=$(MLSDK_ROOT) MLLITE_LIB_NAME=$(MLLITE_LIB_NAME) ANDROID_ROOT=$(ANDROID_ROOT) KERNEL_ROOT=$(KERNEL_ROOT) PRODUCT=$(PRODUCT) -C mllite/mpl/$(TARGET) -f Android-shared.mk $@ $(DUMP)
